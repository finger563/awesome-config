...
globalkeys = awful.util.table.join(
   ...
   awful.key({     }, "#69", function() awful.util.spawn("amixer -c 1 set Master 5%+", false) end),
   awful.key({     }, "#68", function() awful.util.spawn("amixer -c 1 set Master 5%-", false) end),
   awful.key({     }, "#67", function() awful.util.spawn("amixer -c 1 -D pulse set Master 1+ togglemute", false) end),
